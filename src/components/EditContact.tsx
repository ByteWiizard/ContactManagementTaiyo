...
// To Edit the contact EditContactQueryFunction Query function will  be called
...
const EditContact = () => {
  ...
  const { id, firstName, lastName, contactNumber, status, Gender } = completeListObj.editContactData;
  ...
  return (
    <div className="overflow-visible md:h-screen min-h-[580px] md:w-full flex flex-col md:text-center items-center justify-center border text-[#36454F] bg-[#F3F3F3]">
      ...
      <form onSubmit={submitEditForm}>
        <div className="flex flex-col md:w-[600px] w-[600px] mx-5 border p-10 h-fit bg-white rounded-xl drop-shadow-2xl items-center justify-center">
        ...
        <div className="flex justify-center">
          <button
            className="hover:bg-gray-600 md:h-[50px] h-[40px] w-[200px] text-white font-bold rounded-xl drop-shadow-md bg-gray-800 mt-5 "
            type="submit"
